	...
	function MainController($timeout, $log, $scope, $mdDialog, $location) {
		...
		$scope.philos = [
			{ title: 'Un style de vie, un dessin',
			  ...
			  link : '/un-dessin-par-style-de-vie'},
		...
		$scope.news = [
			...
			{ title: 'Le studio signe le Mas d\'Estel',
				desc: 'Le résultat est largement à la hauteur de nos espérance. La saison 2016 est pour bientôt. Reservez votre Bed, et venez découvrir la magie du lieu.',
				image: '/assets/images/actu2.jpg',
				link:''
			},
			{ title: 'Première maison de bois en construction',
				desc: 'En partenariat avec la société PWH, le studio signe une première maison au Plan-de-la-Tour. La commande est lancée! Elle sera visible à partir du mois de Mai. N\'hésitez pas à nous contacter pour la voir de plus près.' ,
		...
		$scope.services = [
			{ title: 'Architecture d\'intérieur', 
				desc: 'Le studio vous accompagne sur vos projets d’aménagements et de rénovations de votre habitation de l’étude à la réalisation...',
				...
				link:'interieur',
				img:'http://localhost:3000/assets/images/suissa.jpg'
			},
			{ title: 'Architecture maison de bois',
				desc: 'En partenariat avec la société PWH, le Studio vous accompagne de la conception, au dépôt de permis de construire, jusqu’à la remise des clés... ',
				// Une maison en bois sur mesure, calquée sur votre style de vie.
				image: '<path d="M32,8L4,56H60ZM30,52H12.6l8.7-15.2m2.8-6,7.7-13.5L51.4,52H36" style="fill: #1d1d1b"/>',
				link:'bois', 
				img:'http://localhost:3000/assets/images/sketch.jpg'
			},
			{ title: 'Hotels, Restaurants, Bars, Clubs',
				...
				link:'hospitalite',
				img:'http://localhost:3000/assets/images/silencio.jpg'
			},
			...
			// },
			{ title: 'Outdoor', 
				desc: 'Le studio vous accompagne dans la conception, la décoration, de vos espaces outdoor. Choix du mobilier création d’ambiances, éclairage... ',
				// En partenariat avec notre paysagiste, nous dessinons vos espaces extérieurs.
